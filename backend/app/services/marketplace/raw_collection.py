...
def raw_card_key(card: dict[str, Any]) -> str:
    """Build a stable per-platform identity for a raw marketplace card across scroll rounds."""
...
class RawCardAccumulator:
    """Keep first-seen rank order while enriching cards seen again after scrolling."""

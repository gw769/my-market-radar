...
export default function Login() {
  ...
  return <div className="login-screen">
    <section className="login-story">
      ...
      <div className="story-points"><span>MYR 定价带</span><span>定时跟踪</span><span>公开数据</span></div>
    </section>
    <section className="login-panel"><form onSubmit={submit} className="login-card">
      <div className="login-title"><ShieldCheck size={22} /><div><h2>进入市场情报台</h2><p>使用你的部署账号登录</p></div></div>
      <label>邮箱<input value={email} onChange={(e) => setEmail(e.target.value)} type="email" autoComplete="username" required /></label>
